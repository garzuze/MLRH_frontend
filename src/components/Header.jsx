...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 flex justify-between items-center py-6 px-8 md:px-32 bg-black/55 drop-shadow-md backdrop-blur-md font-roboto">
            ...
            <ul className="hidden xl:flex items-center gap-12 text-base text-gray-200 font-roboto">
                <li className="p-3 hover:font-bold">Home</li>
                <li className="p-3 hover:font-bold">Currículo</li>
                <li className="p-3 hover:font-bold">Vagas</li>
                <li className="p-3 hover:font-bold">Serviços</li>
                <li className="p-3 hover:font-bold">Sobre nós</li>
                <li className="p-3 hover:font-bold">Contato</li>
            </ul>
